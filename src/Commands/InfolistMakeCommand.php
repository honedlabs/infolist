...
#[AsCommand(name: 'make:infolist')]
class InfolistMakeCommand extends GeneratorCommand
{
    /**
    ...
    {
        return $this->resolveStubPath('/stubs/honed.infolist.stub');
    }
    ...
    {
        return [
            ['force', null, InputOption::VALUE_NONE, 'Create the class even if the infolist already exists'],
        ];
    }
